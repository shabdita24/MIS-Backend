...
public interface FileSauBranchInventoryRepository extends JpaRepository<FileSauBranchInventory, String> {
	...
	Optional<FileSauBranchInventory> findBySauBranchAndCommand(String sau,String command);
	List<FileSauBranchInventory> findByParentIdAndCommand(int sau,String command);
	Optional<FileSauBranchInventory> findBySauIdAndCommand(int sau,String command);
	@Transactional
