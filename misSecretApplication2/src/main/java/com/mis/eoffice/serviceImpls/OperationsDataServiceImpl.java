...
//	//	Total Files In Inbox
	...
	public Integer getTotalFileInbox(String sauName)
	{
		...
		List<FileInventory> inboxFiles = fileInventoryRepository.findByCurrDepAndMisTypeAndTaskState(sauName,"FILE",state);
	...
	public Integer getGrtFiveLessTenFile(String sauName)
	{
		...
		List<FileInventory> sauData = fileInventoryRepository.findByCurrDepAndMisTypeAndTaskStateAndDateTimeRecievedBetween( sauName,"FILE",state,sevendaysbefore,threedaysbefore);
	...
	public Integer getBeforeFiveFile(String sauName)
	{
		...
		List<FileInventory> sauData = fileInventoryRepository.findByCurrDepAndMisTypeAndTaskStateAndDateTimeRecievedAfter( sauName,"FILE",state,fivedaysafter);
	...
	public Integer getGrtTenFile(String sauName)
	{
		...
		Date sevendaysbefore = Date.from(sevenDays.atStartOfDay(ZoneId.systemDefault()).toInstant());
//		Date today=Date.from(currentDate.atStartOfDay(ZoneId.systemDefault()).toInstant());
		List<FileInventory> sauData = fileInventoryRepository.findByCurrDepAndMisTypeAndTaskStateAndDateTimeRecievedBefore( sauName,"FILE",state,sevendaysbefore);
