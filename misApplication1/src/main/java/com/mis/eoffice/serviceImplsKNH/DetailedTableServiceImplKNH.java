...
//	String status = Messages.getString("OperationsDataServiceImpl.FILESTATUS");
	...
	public ResponseDetailTable getdetailedtableInboxFile(String sauName, Integer num,String command,Integer pageNo, Integer rows) {
		...
		if (sauDat.isPresent()) {
			...
			List<FileInventoryKNH> hd1 = filerepo.findByInitiatedBySauAndMisTypeAndTaskState(sauName, "FILE", status,page);
			List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskState(sauName, "FILE", status);
			size=hd2.size();
			if (hd1.size() > 0) {
	...
	public ResponseDetailTable getdetailedtablepend37(String sau, Integer num,String command, Integer pageNo, Integer rows) {
		...
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBetween(sau,
...
//	}
	...
	public ResponseDetailTable getdetailedtablepro30days(String sau, Integer num,String command, Integer pageNo, Integer rows) {
		...
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBefore(sau,
	...
	public ResponseDetailTable getdetailedtablependingat1020(String sauName, Integer num,String command,Integer pageNo, Integer rows) {
		...
		int size=0;
		Pageable page = PageRequest.of(pageNo, rows);
		List<FileInventoryKNH> hd1 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBetween(sauName, "FILE", status,sevendaysbefore, threedaysbefore,page);
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBetween(sauName,
				"FILE", status, sevendaysbefore, threedaysbefore);
		size=hd2.size();
		Optional<HierarchyDataInventory> sauDat = htrepo.findBySauNameAndCommand(sauName,command);
		if (sauDat.isPresent()) {
	...
	public ResponseDetailTable getdetailedtablependingatten(String sau, Integer num,String command, Integer pageNo, Integer rows) {
		...
		int size=0;
		Pageable page = PageRequest.of(pageNo, rows);
		List<FileInventoryKNH> hd1 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBefore(sau, "FILE", taskstate, lastDate,page);
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedBefore(sau,
				"FILE", taskstate, lastDate);
		size=hd2.size();
		Optional<HierarchyDataInventory> sauDat = htrepo.findBySauNameAndCommand(sau,command);
...
//		Date currentDate = Date.from(currentDate1.atStartOfDay(ZoneId.systemDefault()).toInstant());
		...
		int size=0;
		Pageable page = PageRequest.of(pageNo, rows);
		List<FileInventoryKNH> hd1 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedAfter(sau, "FILE", taskstate, lastDate,page);
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedAfter(sau,"FILE", taskstate, lastDate);
		size=hd2.size();
		Optional<HierarchyDataInventory> sauDat = htrepo.findBySauNameAndCommand(sau,command);
		if (sauDat.isPresent()) {
...
//		Date currentDate = Date.from(currentDate1.atStartOfDay(ZoneId.systemDefault()).toInstant());
		...
		List<FileInventoryKNH> hd1 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedAfter(sau,
				"FILE", taskstate, lastDate,page);
		List<FileInventoryKNH> hd2 = filerepo.findByInitiatedBySauAndMisTypeAndTaskStateAndDateTimeRecievedAfter(sau,
				"FILE", taskstate, lastDate);
		size=hd2.size();
		Optional<HierarchyDataInventory> sauDat = htrepo.findBySauNameAndCommand(sau,command);
		if (sauDat.isPresent()) {
