...
public interface DetailedTableService {
	...
	ResponseDetailTable getdetailedtablependingat1020(String upperCase, Integer num, String command, Integer currentPage, Integer pageSize);
	...
	ResponseDetailTable getdetailedtablependingGreater20(String upperCase, Integer num, String command, Integer currentPage, Integer pageSize);
