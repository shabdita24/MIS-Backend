...
public interface DetailedTableService {
	...
	List<DetailedTable> getdetailedtablependingat1020(String upperCase, Integer num, String command);
	...
	List<DetailedTable> getdetailedtablependingGreater20(String upperCase, Integer num, String command);
